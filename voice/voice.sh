#!/bin/bash
#script by C✓T-L
#redesciged by Fazlul
#Youtube : S M Fazlul Hoque Official
clear
if [[ -e ngrok ]]; then
rm -rf ngrok
fi
...
printf "Re-Designed By: FAZLUL_HOQUE \n" |lolcat
printf " YouTube: S M Fazlul Hoque Official\n" |lolcat
...
#if [[ -e ngrok ]]; then
cd $HOME
#cp -r ngrok /sdcard/folder2/EDIOT/EDIOT/voice
chmod +x ngrok
#cd /sdcard/folder2/EDIOT/EDIOT/voice
#echo ""
#else
...
#cd voice
cd voice
#cd /data/data/com.termux/files/home/EDIOT/voice
sleep 10
